...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val comHand = getHand()
        when(comHand) {
            gu -> binding.comHanImage.setImageResource(R.drawable.com_gu)
            choki -> binding.comHanImage.setImageResource(R.drawable.com_choki)
            pa -> binding.comHanImage.setImageResource(R.drawable.com_pa)
        }
